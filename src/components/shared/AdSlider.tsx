    ...
    >
      ...
      >
        {displayAds.map((ad, index) => (
          <div key={ad.id} className="min-w-full h-full relative flex items-center shrink-0 rounded-3xl overflow-hidden">
            ...
            <div className="relative z-10 p-8 md:p-16 w-full flex flex-col justify-center items-start h-full max-w-3xl">
              ...
              <button className="bg-white text-slate-900 px-8 py-3 rounded-full font-bold hover:bg-slate-100 transition-colors shadow-lg cursor-pointer transform hover:scale-105 duration-200">
                {ad.ctaText}
              </button>
            </div>
          </div>
      ...
      <button 
        onClick={prevSlide}
        className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/40 backdrop-blur-md p-2 rounded-full text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300"
      ...
      <button 
        onClick={nextSlide}
        className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/40 backdrop-blur-md p-2 rounded-full text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300"
